...
incorrect_sentences = ["Ths is an exmple.", "He went to the stor."]
correct_sentences = ["This is an example.", "He went to the store."]

def pyspell_correct(sentence):
    corrected_words = [pyspell_checker.correction(word) for word in sentence.split()]
